                    ...
                    <div class="col-12">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control form-control-sm" name="person_quantity"
                                   id="person_quantity" value="1" required min="1" step="1">
                        </div>
                        <div class="form-group">
                            <label for="hours">Количество часов*</label>
                            <input type="number" class="form-control form-control-sm" name="hours" id="hours" value="1"
